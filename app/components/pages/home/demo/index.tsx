        ...
        <div className="container flex items-start justify-between flex-col-reverse lg:flex-row">
          <div className="w-full lg:max-w-[530px]">
            ...
            <p className="text-gray-400 my-6 text-sm sm:text-base">
              ...
              Com o <b>Receita Mágica</b>, cozinhar nunca foi tão fácil e divertido. Basta dizer o que você tem na despensa, e nosso app faz toda a mágica! Em segundos, você terá uma receita personalizada, feita sob medida para os ingredientes que você tem em casa.<br></br>
